...
(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(media) {
			...
			listItem += "<a class='" + this.options.playlistOptions.removeItemClass + "'>&times;</a>";
			...
			listItem += "<a class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + media.title + (media.artist ? " <span class='jp-artist'>by " + media.artist + "</span>" : "") + "</a>";
			listItem += "</div></li>";
		...
		play: function(index) {
			...
			//Callback
			if(typeof this.options.playlistOptions.onPlay == "function") {
				this.options.playlistOptions.onPlay.call(this);
			}
		},
		pause: function() {
		...
		next: function() {
			...
			//Callback
			if(typeof this.options.playlistOptions.onNext == "function") {
