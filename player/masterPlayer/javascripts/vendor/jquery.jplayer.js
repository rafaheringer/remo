...
*/
		...
		_init: function() {
			...
			if(this.require.audio) { // If a supplied format is audio
				...
				this.htmlElement.audio.setAttribute("MsAudioCategory", "backgroundCapableMedia");
				this.htmlElement.audio.setAttribute("msaudiocategory", "backgroundcapablemedia");
				this.htmlElement.audio.setAttribute("AudioCategory", "backgroundCapableMedia");
				this.htmlElement.audio.setAttribute("audioCategory", "backgroundCapableMedia");
			...
			if(this.html.used) { // If only HTML, then emulate flash ready() call after 100ms.
				setTimeout( function() {
